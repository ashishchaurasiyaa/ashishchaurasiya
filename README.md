...
| **YES Platform** | Safety certifications + NFC asset tracking | Django 5.2 · WeasyPrint · AWS |
...
`SAP HANA` `Odoo v15/v17` `Exotel` `MasterIndia GST` `Razorpay` `PayU`
`Google Ads/GA4` `Twilio` `Postmark` `Web3/Ethereum` `M-Pesa` `Firebase`
